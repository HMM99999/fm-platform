package org.fm.common.constant;
...
public interface CommonConstant {
    ...
    /** 登录用户Shiro权限缓存KEY前缀 */
    public static String PREFIX_USER_SHIRO_CACHE  = "shiro:cache:org.fm.config.shiro.ShiroRealm.authorizationCache:";
    /** 登录用户Token令牌缓存KEY前缀 */
...
//    int  TOKEN_EXPIRE_TIME  = 3600;
    ...
    */
    ...
    /**
     * ::非常重要::
     * 注意：这四个常量值如果修改，需要与 jeecg-boot-starter/jeecg-boot-common/org.fm.config.FeignConfig 类中的值保持一致。
     */
