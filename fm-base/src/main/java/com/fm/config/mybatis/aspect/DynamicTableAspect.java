package com.fm.config.mybatis.aspect;
...
import com.fm.common.aspect.annotation.DynamicTable;
import com.fm.common.constant.CommonConstant;
import com.fm.common.util.SpringContextUtils;
import com.fm.config.mybatis.ThreadLocalDataHelper;
...
public class DynamicTableAspect {
     ...
     * 定义切面拦截切入点
     */
    @Pointcut("@annotation(com.fm.common.aspect.annotation.DynamicTable)")
