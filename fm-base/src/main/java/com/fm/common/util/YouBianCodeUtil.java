...
//			com.fmframework.core.util.LogUtil.info(after_code);
//			com.fmframework.core.util.LogUtil.info(after_code_zimu);
//			com.fmframework.core.util.LogUtil.info(after_code_num);
...
//		// com.fmframework.core.util.LogUtil.info(getNextZiMu('C'));
//		// com.fmframework.core.util.LogUtil.info(getNextNum(8));
//	    // com.fmframework.core.util.LogUtil.info(cutYouBianCode("C99A01B01")[2]);
//	}
}
